...
Description: |
    ...
    The following metadata is required:
        ...
        - Assay has protocol, technology type, instrument model, and fixed and/or variable modification or protein modification in correct format
MajorVersion: 1
MinorVersion: 0
PatchVersion: 5
Publish: true
...
Tags:
  ...
  - Name: proteomics
ReleaseNotes: |
  - Bug fix / feature: Also accept DBPO:0000112 ("tissue") as term for Tissue
  - Bug fix / feature: Also accept MOD:00000 ("protein modification") as term for Modification
---
*)"""
                ...
                fun iparams ->
                    ...
                    |> List.exists (
                        fun iparam -> 
                            ...
                            iparam.Value = ParamValue.CvValue (CvTerm.create("MOD:00000","protein modification","MOD"))
                    )
            )
        }
